...
function Card({ children }: { children: React.ReactNode }) {
    return <div className="bg-gray-900 rounded-2xl shadow-lg p-2">{children}</div>;
}

function Button({ children, className, onClick }: { children: React.ReactNode; className?: string; onClick?: () => void }) {
    return (
        <button onClick={onClick} className={`px-6 py-2 rounded-xl font-medium transition ${className}`}>
            {children}
        </button>
    );
}
...
export default function Home() {
    ...
    return (
        <>
            <section className="text-center max-w-4xl my-16 px-4">
                ...
                <Button
                    className="mt-6 border border-purple-500 bg-transparent text-purple-400 hover:bg-purple-500 hover:text-black hover:cursor-pointer"
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-10 my-20 max-w-6xl w-full px-6">
                <div>
            ...
            <section className="grid grid-cols-1 md:grid-cols-2 gap-10 mt-20 max-w-6xl w-full px-6">
